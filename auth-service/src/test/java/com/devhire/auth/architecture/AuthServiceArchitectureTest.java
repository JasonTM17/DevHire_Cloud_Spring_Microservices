package com.devhire.auth.architecture;
...
class AuthServiceArchitectureTest {
    private static final String ROOT_PACKAGE = "com.devhire.auth";
    ...
    private void assertNoDependency(String sourcePackageMarker, String targetPackageMarker) {
        var violations = classes.stream()
                .filter(javaClass -> javaClass.getPackageName().contains(sourcePackageMarker.replace("..", ".")))
