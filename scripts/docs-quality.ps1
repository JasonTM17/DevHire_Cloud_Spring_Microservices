...
$requiredPaths = @(
    ...
    "assessment-runner-service/pom.xml",
    "frontend/e2e/code-assessment-flow.spec.ts",
    ...
    "scripts/code-assessment-smoke.ps1",
    "scripts/judge0-smoke.ps1",
    "scripts/dockerhub-image-verify.ps1",
    ...
    "docs/release-evidence/v0.6.0.md",
