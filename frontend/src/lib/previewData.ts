...
export const previewCodeAssessments: CodeAssessment[] = [
  {
    ...
    level: "Senior",
    language: "Java",
    prompt: "Implement CandidateSolution.solve(String input) so the runtime judge validates production-tagged resources with EnterpriseSecurityPolicy.STRICT.",
    constraints: "The Judge0 harness calls CandidateSolution.solve(String input). Return PASSED or REJECTED without network, filesystem, or process execution.",
    ...
    rubric: [
      { category: "Correctness and completeness", score: 36, maxScore: 40, evidence: "CandidateSolution.solve handles production, relaxed policy, and tag-filtering cases." },
      { category: "Maintainability and readability", score: 18, maxScore: 20, evidence: "Solution class and validator boundary remain clear and reviewable." },
      ...
      { category: "Input parsing and edge cases", score: 9, maxScore: 10, evidence: "Runtime visible cases and server-side hidden cases executed." }
    ],
    riskFlags: [],
    feedback: "Strong production-ready submission with clear validator signals and low review risk.",
    aiFeedbackFallback: true,
    submittedCode: "class CandidateSolution {\n  String solve(String input) {\n    ResourceValidator validator = new ResourceValidator(EnterpriseSecurityPolicy.STRICT, \"production\");\n    return validator.validate(input) ? \"PASSED\" : \"REJECTED\";\n  }\n}\n\nenum EnterpriseSecurityPolicy { STRICT }\n\nclass ResourceValidator {\n  private final EnterpriseSecurityPolicy policy;\n  private final String requiredTag;\n\n  ResourceValidator(EnterpriseSecurityPolicy policy, String requiredTag) {\n    this.policy = policy;\n    this.requiredTag = requiredTag;\n  }\n\n  boolean validate(String input) {\n    return this.policy == EnterpriseSecurityPolicy.STRICT && input != null && input.contains(\"policy=STRICT\") && input.contains(\"tag=\" + this.requiredTag);\n  }\n}",
    attemptNumber: 2,
    ...
    submittedCodePreview: "class CandidateSolution { String solve(String input) { ResourceValidator validator = new ResourceValidator(EnterpriseSecurityPolicy.STRICT,...",
    hasSubmittedCode: true,
    visibleTestCases: [
      { id: "preview-case-resource-visible-1", name: "Runtime solve contract", visibility: "VISIBLE", input: "resource=res-9982;policy=STRICT;tag=production", weight: 15 },
      { id: "preview-case-resource-visible-2", name: "Policy Enforcement", visibility: "VISIBLE", input: "resource=res-2211;policy=RELAXED;tag=production", weight: 15 },
      { id: "preview-case-resource-visible-3", name: "Tag Filtering", visibility: "VISIBLE", input: "resource=res-4420;policy=STRICT;tag=staging", weight: 10 }
    ],
    latestRun: {
      ...
      similarityScore: 4.2,
      results: [
        { caseId: "preview-case-resource-visible-1", name: "Runtime solve contract", visibility: "VISIBLE", passed: true, verdict: "ACCEPTED", output: "PASSED", stdout: "PASSED", executionTimeMs: 62, memoryKb: 18432, timeLimitMs: 2000, memoryLimitKb: 131072 },
        { caseId: "preview-case-resource-visible-2", name: "Policy Enforcement", visibility: "VISIBLE", passed: true, verdict: "ACCEPTED", output: "REJECTED", stdout: "REJECTED", executionTimeMs: 84, memoryKb: 24576, timeLimitMs: 2000, memoryLimitKb: 131072 },
        { caseId: "preview-case-resource-visible-3", name: "Tag Filtering", visibility: "VISIBLE", passed: true, verdict: "ACCEPTED", output: "REJECTED", stdout: "REJECTED", executionTimeMs: 68, memoryKb: 22528, timeLimitMs: 2000, memoryLimitKb: 131072 }
      ],
      createdAt: daysAgo(1),
  ...
  },
  {
    ...
    rubric: [
      ...
      { category: "Input parsing and edge cases", score: 6, maxScore: 10, evidence: "Needs stronger malformed-input coverage." }
    ],
    riskFlags: ["low-signal-code"],
    feedback: "Promising submission. Employer review should focus on edge cases, input parsing robustness, and stale queue behavior.",
    aiFeedbackFallback: true,
    ...
    latestRun: {
      ...
      results: [
        { caseId: "preview-case-sql-visible-1", name: "Visible tenant scope", visibility: "VISIBLE", passed: true, verdict: "ACCEPTED", output: "SUBMITTED=12,INTERVIEW=5", stdout: "SUBMITTED=12,INTERVIEW=5", executionTimeMs: 38, memoryKb: 16384, timeLimitMs: 2000, memoryLimitKb: 131072 },
        { caseId: "preview-case-sql-visible-2", name: "Visible grouped status", visibility: "VISIBLE", passed: true, verdict: "ACCEPTED", output: "SUBMITTED=12,INTERVIEW=5", stdout: "SUBMITTED=12,INTERVIEW=5", executionTimeMs: 50, memoryKb: 18432, timeLimitMs: 2000, memoryLimitKb: 131072 }
      ],
      createdAt: daysAgo(2),
  ...
  },
  {
    ...
    starterCode: "class CandidateSolution {\n  String solve(String input) {\n    return input != null && input.contains(\"OpenSearch\") ? \"PUBLISHED_ONLY\" : \"POSTGRES_FALLBACK\";\n  }\n}",
    status: "ASSIGNED",
    maxScore: 100,
...
export const previewCodeAssessmentSummary: CodeAssessmentSummary = {
  ...
  acceptedRate: 88.6,
  wrongAnswerRate: 7.2,
  compileErrorRate: 2.1,
  timeoutRate: 1.4,
  runnerUnavailableRate: 0.7,
  policyBlockedRate: 0.5,
  averageRuntimeMs: 118.6,
  p95ExecutionMs: 244,
