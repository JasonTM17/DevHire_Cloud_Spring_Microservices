...
| `-Docs` | docs quality, visual evidence audit, and `git diff --check` |
| `-All` | all scopes |
...
| `-Docs` | docs quality, version consistency, API compatibility manifest, evidence audit, repository hygiene, visual evidence audit, and `git diff --check` |
