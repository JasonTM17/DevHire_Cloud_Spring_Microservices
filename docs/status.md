...
| Open pull requests | 2 active Stitch redesign PRs: #43 base redesign and #44 fidelity polish |
...
| Stitch v0.6 | PR #43 and #44 are green and waiting for required review before protected-branch merge. |
