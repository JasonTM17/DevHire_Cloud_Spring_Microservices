...
| Code assessment | deterministic rubric grading、Judge0-compatible internal runner boundary、hidden/visible cases、integrity signals、employer review、admin health metrics |
