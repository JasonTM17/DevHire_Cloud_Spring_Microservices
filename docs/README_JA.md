...
| 現在の hardening evidence | `v0.4.9` cloud completion PR は green。release tag は protected branch merge 後 | [Review evidence](REVIEW_EVIDENCE.md), [cloud evidence](release-evidence/v0.4.9.md) |
